...
public class Move : Ability {
    ...
    public void accelerate(Rigidbody2D rb, Vector2 direction, float acceleration, float force, float maxSpeed) {

        // Add force  to the rigidbody in the movement direction multiplied by the acceleration to speed it up
        rb.AddForce(direction * acceleration * force, ForceMode2D.Force);
     ...
     public void decelerate(Rigidbody2D rb, float deceleration, float force) {
